...
* **waxSigningURL**: Set it to https://all-access.waxtest.net to run on testnet, **DON'T SET THIS ON MAINNET**  *Optional*.
...
Testnet environment don't support free bandwidth.
...
Testnet environment don't support fee fallback.
